...
extern struct node* createNode(pid32);

extern struct resourceGraph* createGraph(int);

extern void addEdge(struct resourceGraph*, pid32, pid32);

extern int edgeExists(struct resourceGraph*, pid32, pid32);

extern void test(sid32);

extern int detectCycle(struct resourceGraph*, pid32);

extern void cycleDetectionHelper(struct resourceGraph*, pid32, int[], int[]);

extern void test1();

extern void test2(sid32, sid32);

extern void deleteAllEdges(struct resourceGraph*, pid32);

extern void deleteOwner(struct sentry *semptr, pid32 pid);
